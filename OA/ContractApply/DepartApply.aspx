<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Manage.Master" CodeBehind="DepartApply.aspx.cs" Inherits="OA.ContractApply.DepartApply" %>
                     ...
                     <table style="width:100%; text-align:center;">
                        ...
                        <tr>
                            <td colspan="2" style=" vertical-align:top;">
                                  <asp:GridView ID="gvContract" runat="server" AutoGenerateColumns="false" CellPadding="1" AllowSorting="true" Width="100%" DataKeyNames="ContractApplyId" OnRowDataBound="gvContract_RowDataBound" OnRowDeleting="gvContract_RowDeleting" OnSorting="gvContract_Sorting" >
                                    <Columns>
