<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Apply.Master" CodeBehind="ManagerApprove.aspx.cs" Inherits="OA.ContractApply.ManagerApprove" %>
        ...
        <tr>
           ...
           <tr>
                ...
                <td><asp:Label ID="lblSectionView" runat="server"></asp:Label></td>
                 <td>总经理意见</td>
                <td><asp:TextBox ID="txtMangerView" runat="server" TextMode="MultiLine"></asp:TextBox></td>
            </tr>
        </table>
        </td>
        </tr>
