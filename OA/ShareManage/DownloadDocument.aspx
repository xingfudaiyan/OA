<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Manage.Master" CodeBehind="DownloadDocument.aspx.cs" Inherits="OA.ShareManage.DownloadDocument" %>
                            ...
                            <td colspan="2" style="height:300px; vertical-align:top;">
                                  <asp:GridView ID="gvFile" runat="server" AutoGenerateColumns="False" AllowSorting="true"  DataKeyNames="FileId" CellPadding="3" Width="100%" EmptyDataText="没有数据" OnSorting="gvFile_Sorting"  >
                                        <Columns>
                                            ...
                                            <asp:TemplateField >
                                                <ItemTemplate>
                                                    <asp:Image ID="img" runat="server" ImageUrl='<%#Eval("IsMsg1").ToString() == "0" ? "~/images/fileclose.gif" : "~/images/fileopen.gif"%>'  />
                                                </ItemTemplate>
                                             </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="共享人" SortExpression="EmployeeName">
                                                <ItemTemplate>
