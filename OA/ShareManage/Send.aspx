<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Manage.Master"  CodeBehind="Send.aspx.cs" Inherits="OA.ShareManage.Send" %>
                            ...
                            <td colspan="2">
                                <table class="Tb_Blank1" style="width:100%">
                                    <tr>
                                        ...
                                        <td style="width:10%;"><asp:Button ID="btnSend" runat="server" Text="发送文件" OnClick="btnSend_Click" /></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                                  ...
                                  <asp:GridView ID="gvFile" runat="server" AutoGenerateColumns="False" AllowSorting="true" DataKeyNames="FileId" CellPadding="3" Width="100%" EmptyDataText="没有数据" OnSorting="gvFile_Sorting" >
                                   <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="备注" SortExpression="Memo">
                                     ...
                                     <asp:TemplateField HeaderText="接收人" SortExpression="EmployeeName">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="下载">
                                        <ItemTemplate>
                                            <a href="SendDownLoadFile.aspx?fileid=<%#Eval("FileId") %>" target="I2" style="text-decoration:none;">查看</a>
                                        </ItemTemplate>
                                        <ItemStyle Width="10%" />
                                    </asp:TemplateField>
                                </Columns>
