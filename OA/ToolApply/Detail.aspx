<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Apply1.Master" CodeBehind="Detail.aspx.cs" Inherits="OA.ToolApply.Detail" %>
            ...
            <td>
                ...
                <table class="Tb_Blank" style="width:100%;">
                    <tr>
                        ...
                        <td style="width:25%;"><asp:Label ID="lblManagerView" runat="server"></asp:Label></td>
                    </tr>
                </table>
            </td>
        </tr>
