<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Manage.Master"  CodeBehind="ManagerGv.aspx.cs" Inherits="OA.ToolApply.ManagerGv" %>
                                 ...
                                 <asp:GridView ID="gvTool" runat="server" AutoGenerateColumns="false" CellPadding="1" AllowSorting="true" Width="100%" DataKeyNames="ToolId" OnRowDataBound="gvTool_RowDataBound" OnSorting="gvTool_Sorting" >
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="申请时间" SortExpression="ApplyTime">
                                              ...
                                              <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:Button ID="btnSubmit" Text="审批" runat="server" CommandArgument='<%#Eval("ToolId") %>' CausesValidation="false" OnClick="btnSubmit_Click"   />
                                                </ItemTemplate>
                                                 <ItemStyle Width="10%" />
                                            </asp:TemplateField>
                                        </Columns>
