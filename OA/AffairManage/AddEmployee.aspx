<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Apply1.Master" CodeBehind="AddEmployee.aspx.cs" Inherits="OA.AddEmployee" %>

<asp:Content ContentPlaceHolderID="Content1" runat="server">
<table class="Tb_Blank" style="width:100%;">
    <tr>
        <td colspan="2"><h2>添加员工信息</h2></td>
    </tr>
    <tr>
        <td colspan="2">
            <table class="Tb_Common">
                <tr>
                    ...
                    <td rowspan="4" colspan="2" style="width:34%;">
                     <asp:Image ID="ImgInit" runat="server" ImageUrl="~/Photo/NewImage.jpg"  />
                    </td>
                </tr>
                 <tr>
