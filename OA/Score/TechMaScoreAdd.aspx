<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TechMaScoreAdd.aspx.cs" MasterPageFile="~/Apply1.Master" Inherits="OA.Score.TechMaSocre" %>
                ...
                <td>
                    <table class="Tb_Common" style="width:100%;">
                        ...
                        <tr>
                            ...
                            <td><input id="input1" type="text" name="Project1" class="Input1" /></td>
                            <td></td>
                            <td></td>
                            <td>10</td>
                        </tr>
                       <tr>
                            ...
                            <td><input id="Text1" type="text" name="Project2" class="Input1" /></td>
                            <td></td>
                            <td></td>
                            <td>10</td>
                       </tr>
                       <tr>
                            ...
                            <td><input id="Text2" type="text" name="Project3" class="Input1" /></td>
                            <td></td>
                            <td></td>
                            <td>5</td>
                       </tr>
                        <tr>
                            ...
                            <td><input id="Text3" type="text" name="Project4" class="Input1" /></td>
                            <td></td>
                            <td></td>
                            <td>5</td>
                       </tr>
                        <tr>
                            <td rowspan="4">团队管理<br />及协作</td>
                            <td colspan="4">相关工程师工作的合理分配</td>
                            <td><input id="Text4" type="text" name="Project5" class="Input1" /></td>
                            <td></td>
                            <td></td>
                            <td>10</td>
                        </tr>
                         <tr>
                            ...
                            <td><input id="Text5" type="text" name="Project6" class="Input1" /></td>
                            <td></td>
                            <td></td>
                            <td>5</td>
                       </tr>
                        <tr>
                            ...
                            <td><input id="Text6" type="text" name="Project7" class="Input1" /></td>
                            <td></td>
                            <td></td>
                            <td>10</td>
                       </tr>
                        <tr>
                            ...
                            <td><input id="Text7" type="text" name="Project8" class="Input1" /></td>
                            <td></td>
                            <td></td>
                            <td>5</td>
                       </tr>
                       <tr>
                            ...
                            <td><input id="Text8" type="text" name="Project9" class="Input1" /></td>
                            <td></td>
                            <td></td>
                            <td>5</td>
                        </tr>
                        <tr>
                            ...
                            <td><input id="Text9" type="text" name="Project10" class="Input1" /></td>
                            <td></td>
                            <td></td>
                            <td>10</td>
                       </tr>
                        <tr>
                            ...
                            <td><input id="Text10" type="text" name="Project11" class="Input1" /></td>
                            <td></td>
                            <td></td>
                            <td>5</td>
                       </tr>
                         <tr>
                            ...
                            <td><input id="Text11" type="text" name="Project12" class="Input1" /></td>
                            <td></td>
                            <td></td>
                            <td>10</td>
                        </tr>
                         <tr>
                            ...
                            <td><input id="Text12" type="text" name="Project13" class="Input1" /></td>
                            <td></td>
                            <td></td>
                            <td>10</td>
                       </tr>
