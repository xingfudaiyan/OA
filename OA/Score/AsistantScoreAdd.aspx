<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AsistantScoreAdd.aspx.cs" MasterPageFile="~/Apply1.Master"  Inherits="OA.Score.AsistantScoreAdd" %>
                ...
                <td>
                    <table class="Tb_Common" style="width:100%;">
                       ...
                       <tr>
                        ...
                        <td><input type="text" name="Selfas1" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>5</td>
                       </tr>
                       <tr>
                        ...
                        <td><input type="text" name="Selfas2" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>
                            5</td>
                       ...
                       <tr>
                            ...
                            <td><input type="text" name="Selfas3" class="Input1" /></td>
                            <td></td>
                            <td></td>
                            <td>
                                5</td>
                       ...
                       <tr>
                         <td colspan="4">
                            ...
                            <td><input type="text" name="Selfas4" class="Input1" /></td>
                            <td></td>
                            <td></td>
                            <td>
                                5</td>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="Selfas5" class="Input1" /></td>
                            <td></td>
                            <td></td>
                            <td>5</td>
                       </tr>
                       ...
                       <tr>
                        ...
                        <td><input type="text" name="Selfas6" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>
                            5</td>
                       ...
                       <tr>
                        ...
                        <td><input type="text" name="Selfas7" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>
                            5</td>
                        ...
                        <td><input type="text" name="Selfas8" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>
                            5</td>
                        ...
                        <td><input type="text" name="Selfas9" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>
                            5</td>
                        ...
                        <td><input type="text" name="Selfas10" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>
                            5</td>
                       ...
                       <tr>
                        ...
                        <td><input type="text" name="Selfas11" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>5</td>
                       </tr>
                       <tr>
                        <td colspan="4">监督行政助理做好行政相关工作，有违规现象及时指出。</td>
                         <td ><input type="text" name="Selfas12" class="Input1" /></td>
                        <td ></td>
                        <td ></td>
                        <td >
                            5</td>
                       ...
                       <tr>
                        ...
                        <td><input type="text" name="Selfas13" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>
                            5</td>
                        ...
                        <td colspan="4">积极保守公司商业秘密，并能制定相应策略或制度监督其他部门员工执行。</td>
                         <td ><input type="text" name="Selfas14" class="Input1" /></td>
                        <td ></td>
                        <td ></td>
                        <td >
                            5</td>
                       ...
                       <tr>
                        ...
                        <td><input type="text" name="Selfas15" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>
                            5</td>
                       ...
                       <tr>
                        ...
                        <td><input type="text" name="Selfas16" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>
                            5</td>
                   ...
                   <tr>
                        ...
                        <td colspan="4">认真学好会计，尽早取得会计证书。</td>
                         <td ><input type="text" name="Selfas17" class="Input1" /></td>
                        <td ></td>
                        <td ></td>
                        <td >
                            10</td>
                       ...
                       <tr>
                        ...
                        <td><input type="text" name="Selfas18" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>
                            5</td>
                        ...
                        <td><input type="text" name="Selfas19" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>
                            5</td>
