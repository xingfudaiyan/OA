<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DriveScoreAdd.aspx.cs" MasterPageFile="~/Apply1.Master" Inherits="OA.Score.DriveScoreAdd" %>
                ...
                <td>
                    <table class="Tb_Common" style="width:100%;">
                       ...
                       <tr>
                        ...
                        <td><input type="text" name="Selfds1" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>5</td>
                       </tr>
                       <tr>
                        <td colspan="4">
                            <span >
                                工作不偷懒、不倦怠</span></td>
                        <td><input type="text" name="Selfds2" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>5</td>
                       </tr>
                       <tr>
                            <td colspan="4">
                                <span>
                                    做事敏捷、效率高</span></td>
                            <td><input type="text" name="Selfds3" class="Input1" /></td>
                            <td></td>
                            <td></td>
                            <td>8</td>
                       </tr>
                       <tr>
                         <td colspan="4">
                             <span>
                                 遵守上司的指示</span></td>
                            <td><input type="text" name="Selfds4" class="Input1" /></td>
                            <td></td>
                            <td></td>
                            <td>5</td>
                       </tr>
                        <tr>
                            ...
                            <td><input type="text" name="Selfds5" class="Input1" /></td>
                            <td></td>
                            <td></td>
                            <td>5</td>
                       </tr>
                       ...
                       <tr>
                        ...
                        <td><input type="text" name="Selfds6" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>5</td>
                       </tr>
                       <tr>
                        ...
                        <td><input type="text" name="Selfds7" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>3</td>
                       </tr>
                        ...
                        <td><input type="text" name="Selfds8" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>3</td>
                       </tr>
                       <tr>
                        ...
                        <td><input type="text" name="Selfds9" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>5</td>
                       </tr>
                       <tr>
                        ...
                        <td colspan="4">完成每天领导及员工的出车任务</td>
                         <td ><input type="text" name="Selfds10" class="Input1" /></td>
                        <td ></td>
                        <td ></td>
                        <td >8</td>
                       </tr>
                       <tr>
                        ...
                        <td><input type="text" name="Selfds11" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>8</td>
                       </tr>
                       <tr>
                        ...
                        <td><input type="text" name="Selfds12" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>5</td>
                       </tr>
                       <tr>
                        ...
                        <td><input type="text" name="Selfds13" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>5</td>
                       </tr>
                        ...
                        <td colspan="4">责任感强</td>
                         <td ><input type="text" name="Selfds14" class="Input1" /></td>
                        <td ></td>
                        <td ></td>
                        <td >3</td>
                       </tr>
                       <tr>
                        ...
                        <td><input type="text" name="Selfds15" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>3</td>
                       </tr>
                       <tr>
                        ...
                        <td><input type="text" name="Selfds16" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>3</td>
                       </tr>
                   ...
                   <tr>
                        ...
                        <td colspan="4">能与其他同事和睦相处</td>
                         <td ><input type="text" name="Selfds17" class="Input1" /></td>
                        <td ></td>
                        <td ></td>
                        <td >3</td>
                       </tr>
                       <tr>
                        ...
                        <td><input type="text" name="Selfds18" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>3</td>
                       </tr>
                       <tr>
                        ...
                        <td><input type="text" name="Selfds19" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>3</td>
                       </tr>
                       ...
                       <tr>
                        ...
                        <td colspan="4">审查自己的能力，并时常查阅地图熟悉江浙沪地带路线</td>
                         <td ><input type="text" name="Selfds20" class="Input1" /></td>
                        <td ></td>
                        <td ></td>
                        <td >3</td>
                       </tr>
                       <tr>
                        ...
                        <td><input type="text" name="Selfds21" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>3</td>
                       </tr>
                       <tr>
                        ...
                        <td><input type="text" name="Selfds22" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>3</td>
                       </tr>
                        ...
                        <td><input type="text" name="Selfds23" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>3</td>
                       </tr>
