<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AsistantScoregv.aspx.cs" MasterPageFile="~/Manage.Master" Inherits="OA.Score.AsistantScoregv" %>
                     ...
                     <table style="width:100%; text-align:center;">
                        ...
                        <td colspan="2">
                            <table class="Tb_Blank1">
                                <tr>
                                        <td style="width:80%; text-align:right;"><asp:Button ID="btnAdd" runat="server" Text="新增" OnClick="btnAdd_Click" /></td>
                                        <td style="width:20%;"><asp:Button ID="btnJz" runat="server" Text="君众绩效" OnClick="btnJz_Click"  /></td>
                                </tr>
                            </table>
                        </td>
                        </tr>
                        <tr>
                            <td colspan="3" style="height:300px; vertical-align:top;">
                                  <asp:GridView ID="gvScore" runat="server" AutoGenerateColumns="False" DataKeyNames="AssistantScoreId" AllowSorting="True" CellPadding="1" Width="100%" OnRowDataBound="gvScore_RowDataBound" OnRowDeleting="gvScore_RowDeleting" OnSorting="gvScore_Sorting"  >
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="时间" SortExpression="DateSpan"> 
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lblDateSpan" runat="server" style="text-decoration:none;" Text='<%#Eval("DateSpan") %>' CommandArgument='<%#Eval("AssistantScoreId") %>' CausesValidation="false" OnClick="btnDetail_Click" ></asp:LinkButton>
                                                </ItemTemplate>
                                                 <ItemStyle Width="15%" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField ShowHeader="False">
                                                <ItemTemplate>
                                                    <asp:Button ID="btnSubmit" Text="提交" runat="server" CommandArgument='<%#Eval("AssistantScoreId") %>' CausesValidation="false" OnClientClick="return confirm('提交后不能再编辑和删除，确认要提交吗？');" OnClick="btnSubmit_Click"  />
                                                </ItemTemplate>
                                                <ItemStyle Width="5%" />
                                            </asp:TemplateField>
                                            <asp:TemplateField ShowHeader="False">
                                                <ItemTemplate>
                                                    <asp:Button ID="btnEdit" runat="server" CausesValidation="False" CommandName="Edit"
                                                        Text="编辑" CommandArgument='<%#Eval("AssistantScoreId") %>' OnClick="btnEdit_Click"></asp:Button>
                                                </ItemTemplate>
                                                 <ItemStyle Width="5%" />
                                            </asp:TemplateField>
                                            <asp:TemplateField ShowHeader="False">
