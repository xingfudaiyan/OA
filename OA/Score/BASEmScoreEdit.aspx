<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BASEmScoreEdit.aspx.cs" MasterPageFile="~/Apply1.Master" Inherits="OA.Score.BASEmScoreEdit" %>
                ...
                <td>
                    <table class="Tb_Common" style="width:100%;">
                       ...
                       <tr>
                        ...
                        <td><input type="text" name="iSelfbas1" class="Input1" value="<%=Selfbas1 %>" /></td>
                        <td></td>
                        <td></td>
                        <td>10</td>
                       </tr>
                       <tr>
                        ...
                        <td><input type="text" name="iSelfbas2" class="Input1" value="<%=Selfbas2 %>" /></td>
                        <td></td>
                        <td></td>
                        <td>10</td>
                       </tr>
                       <tr>
                            ...
                            <td><input type="text" name="iSelfbas3" class="Input1" value="<%=Selfbas3 %>" /></td>
                            <td></td>
                            <td></td>
                            <td>10</td>
                       </tr>
                       <tr>
                         <td colspan="3">销售报表提交的准确性</td>
                            <td><input type="text" name="iSelfbas4" class="Input1" value="<%=Selfbas4 %>" /></td>
                            <td></td>
                            <td></td>
                            <td>10</td>
                       </tr>
                        <tr>
                            ...
                            <td><input type="text" name="iSelfbas5" class="Input1" value="<%=Selfbas5 %>"/></td>
                            <td></td>
                            <td></td>
                            <td>10</td>
                       </tr>
                       <tr>
                         <td colspan="3">进销存数据的准确性</td>
                            <td><input type="text" name="iSelfbas6" class="Input1" value="<%=Selfbas6 %>"/></td>
                            <td></td>
                            <td></td>
                            <td>10</td>
                       </tr>
                       <tr>
                            ...
                            <td><input type="text" name="iSelfbas7" class="Input1" value="<%=Selfbas7 %>" /></td>
                            <td></td>
                            <td></td>
                            <td>4</td>
                       </tr>
                        <tr>
                            ...
                            <td><input type="text" name="iSelfbas8" class="Input1" value="<%=Selfbas8 %>" /></td>
                            <td></td>
                            <td></td>
                            <td>3</td>
                       </tr>
                       <tr>
                            ...
                            <td><input type="text" name="iSelfbas9" class="Input1" value="<%=Selfbas9 %>" /></td>
                            <td></td>
                            <td></td>
                            <td>3</td>
                       </tr>
                       <tr>
                        ...
                        <td><input type="text" name="iSelfbas10" class="Input1" value="<%=Selfbas10 %>" /></td>
                        <td></td>
                        <td></td>
                        <td>5</td>
                       </tr>
                       <tr>
                        ...
                        <td><input type="text" name="iSelfbas11" class="Input1"value="<%=Selfbas11 %>" /></td>
                        <td></td>
                        <td></td>
                        <td>5</td>
                       </tr>
                        ...
                        <td><input type="text" name="iSelfbas12" class="Input1" value="<%=Selfbas12 %>" /></td>
                        <td></td>
                        <td></td>
                        <td>5</td>
                       </tr>
                       <tr>
                        ...
                        <td><input type="text" name="iSelfbas13" class="Input1" value="<%=Selfbas13 %>" /></td>
                        <td></td>
                        <td></td>
                        <td>5</td>
                       </tr>
                       <tr>
                        ...
                        <td colspan="3" style="height: 25px">迟到或早退一次扣0.5分</td>
                         <td style="height: 25px"><input type="text" name="iSelfbas14" class="Input1" value="<%=Selfbas14 %>" /></td>
                       ...
                       <tr>
                        ...
                        <td><input type="text" name="iSelfbas15" class="Input1" value="<%=Selfbas15 %>" /></td>
                        <td></td>
                        <td></td>
                        <td>2</td>
                       </tr>
                       <tr>
                        ...
                        <td><input type="text" name="iSelfbas16" class="Input1" value="<%=Selfbas16 %>" /></td>
                        <td></td>
                        <td></td>
                        <td>3</td>
                       </tr>
                       <tr>
                        ...
                        <td><input type="text" name="iSelfbas17" class="Input1" value="<%=Selfbas17 %>" /></td>
                        <td></td>
                        <td></td>
                        <td>3</td>
                       </tr>
