<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TechEmScoreEdit.aspx.cs" MasterPageFile="~/Apply1.Master" Inherits="OA.Score.TechEmScoreEdit" %>
                ...
                <td>
                    <table class="Tb_Common" style="width:100%;">
                        ...
                        <tr>
                            ...
                            <td><input id="input1" type="text" name="SelfPlan" class="Input1" value="<%=selfplan %>" /></td><td></td><td></td><td>5</td>
                        </tr>
                        <tr>
                            <td>6.工作量</td>
                            <td colspan="3">月职责内工作及公司整体配合<br />工作总量基本饱和,无长时间空闲现象。</td>
                            <td><input id="Text1" type="text" name="SelfWorkTotal" class="Input1" value="<%=selfworktotal %>" /></td><td></td><td></td><td>5</td>
                        </tr>
                         <tr>
                            <td>7.工作速度</td>
                            <td colspan="3">完成工作迅速、及时，无浪费时间或拖拉现象。</td>
                            <td><input id="Text2" type="text" name="SelfWorkSpeed" class="Input1" value="<%=selfworkspeed %>" /></td><td></td><td></td><td>5</td>
                        </tr>
                         <tr>
                            <td>8.合作性及沟通性</td>
                            <td colspan="3">在人际关系及与其他部门配合方面顺畅和谐，<br />能及时与其他同事进行科学的工作沟通。团队合作性强。</td>
                            <td><input id="Text3" type="text" name="SelfCommunicate" class="Input1"  value="<%=selfcommunicate %>"/></td><td></td><td></td><td>10</td>
                        </tr>
                         <tr>
                            <td>9.纪律性</td>
                            <td colspan="3">严格要求自己遵守公司各项规章制度，纪律性强，<br />无随意违纪、违规现象。（参考日常考勤及规范记录）</td>
                            <td><input id="Text4" type="text" name="SelfDescipline" class="Input1" value="<%=selfdescipline %>" /></td><td></td><td></td><td>5</td>
                        </tr>
                         <tr>
                            <td>10.执行性</td>
                            <td colspan="3">对上级指示、决议、计划坚决执行并督促跟进下级工作。</td>
                            <td><input id="Text5" type="text" name="SelfExecute" class="Input1" value="<%=selfexecute %>" /></td><td></td><td></td><td>10</td>
                        </tr>
                         <tr>
                            <td>11.流程缜密</td>
                            <td colspan="3">工作认真细致，<br />考虑问题的全面，流程遗漏率低，出错率低。</td>
                            <td><input id="Text6" type="text" name="SelfRoute" class="Input1" value="<%=selfroute %>" /></td><td></td><td></td><td>5</td>
                        </tr>
                         <tr>
                            <td>14.职业素质</td>
                            <td colspan="3">职业意识强，有职业道德，言谈举止符合职业特点。</td>
                            <td><input id="Text7" type="text" name="SelfProfession" class="Input1" value="<%=selfprofession %>" /></td><td></td><td></td><td>5</td>
                        </tr>
                         <tr>
                            <td>15.工作态度</td>
                            <td colspan="3">乐观、积极的工作心态，<br />对工作充满热情，有进取精神、勤奋、责任感强。</td>
                            <td><input id="Text8" type="text" name="SelfAttitude" class="Input1" value="<%=selfattitude %>" /></td><td></td><td></td><td>10</td>
                        </tr>
                        <tr>
                            <td rowspan="2">学习成长<br />（季度评）</td>
                            <td>12.综合素质</td>
                            <td colspan="3">主动学习各种学科知识，<br />积极参加各类培训，拓宽知识面，提高综合素质。</td>
                            <td><input id="Text9" type="text" name="SelfComplex" class="Input1" value="<%=selfcomplex %>" /></td><td></td><td></td><td>10</td>
                        </tr>
                         <tr>
                            <td>13.专业技能</td>
                            <td colspan="3">对所任职务所需的专业知识和业务技能掌握熟练，<br />积极组织培训与自我学习，并能运用自如。</td>
                            <td><input id="Text10" type="text" name="SelfSpeciality" class="Input1" value="<%=selfspeciality %>" /></td><td></td><td></td><td>10</td>
                        </tr>
                        <tr>
                            <td colspan="2">奖惩加/减分</td>
                            <td colspan="7"><span style=" float:left;">事由：</span><span>分值：加/减分________ </span> <span style="float:right;">总计本月得分________ </span>   </td>
                        </tr>
                         <tr>
                            <td colspan="2">评价等级</td>
                            <td colspan="7">
                            <asp:RadioButtonList ID="rblLevel" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" Enabled="false">
                                 <asp:ListItem Value="0" Text="优秀91分以上"></asp:ListItem>
                                <asp:ListItem Value="1" Text="良好75～90.99分"></asp:ListItem>
                                <asp:ListItem Value="2" Text="一般60～74.99分"></asp:ListItem>
                                <asp:ListItem Value="3" Text="差60分以下"></asp:ListItem>
                            </asp:RadioButtonList>
                            </td>
                        </tr>
                         <tr>
