<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllScores.aspx.cs" MasterPageFile="~/Manage.Master" Inherits="OA.Score.AllScores" %>
                     ...
                     <table style="width:100%; text-align:center;">
                        ...
                        <td colspan="2">
                            <table class="Tb_Blank1">
                                <tr>
                                        <td style="width:90%; text-align:right;"><asp:Button ID="btnMyScore" runat="server" Text="我的绩效" OnClick="btnMyScore_Click" /> </td>
                                </tr>
                            </table>
                        </td>
                        </tr>
