<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TechMaScoreGv.aspx.cs" MasterPageFile="~/Manage.Master" Inherits="OA.Score.TechMaScoreGv" %>
                     ...
                     <table style="width:100%; text-align:center;">
                        ...
                        <tr>
                            <td colspan="2" style="height:300px; vertical-align:top;">
                                  <asp:GridView ID="gvScore" runat="server" AutoGenerateColumns="False" DataKeyNames="TechMaScoreId" AllowSorting="True" CellPadding="1" Width="100%" OnRowDataBound="gvScore_RowDataBound" OnRowDeleting="gvScore_RowDeleting" OnSorting="gvScore_Sorting"  >
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="时间" SortExpression="DateSpan"> 
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lblDateSpan" runat="server" style="text-decoration:none;" Text='<%#Eval("DateSpan") %>' CommandArgument='<%#Eval("TechMaScoreId") %>' CausesValidation="false" OnClick="btnDetail_Click" ></asp:LinkButton>
                                                </ItemTemplate>
                                                 <ItemStyle Width="15%" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField ShowHeader="False">
                                                <ItemTemplate>
                                                    <asp:Button ID="btnSubmit" Text="提交" runat="server" CommandArgument='<%#Eval("TechMaScoreId") %>' CausesValidation="false" OnClientClick="return confirm('提交后不能再编辑和删除，确认要提交吗？');" OnClick="btnSubmit_Click"  />
                                                </ItemTemplate>
                                                <ItemStyle Width="5%" />
                                            </asp:TemplateField>
                                            <asp:TemplateField ShowHeader="False">
                                                <ItemTemplate>
                                                    <asp:Button ID="btnEdit" runat="server" CausesValidation="False" CommandName="Edit"
                                                        Text="编辑" CommandArgument='<%#Eval("TechMaScoreId") %>' OnClick="btnEdit_Click"></asp:Button>
                                                </ItemTemplate>
                                                 <ItemStyle Width="5%" />
                                            </asp:TemplateField>
                                            <asp:TemplateField ShowHeader="False">
