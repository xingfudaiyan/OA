...
namespace OA.Score
{
    public partial class AsistantScoregv : System.Web.UI.Page
    {
        ...
        protected void gvDataBind()
        {
            ...
            DataTable dt = BasEmScoreInfo.getAssistantScore(emid);
        ...
        {
            int AsId = Convert.ToInt32(((LinkButton)sender).CommandArgument.ToString());
            Response.Redirect("AsistantScoreDetail.aspx?AssistantScoreId=" + AsId);
        }


        protected void btnAdd_Click(object sender, EventArgs e)
        {
            Response.Redirect("AsistantScoreAdd.aspx");
        }
        ...
        {
            int AsScoreId = Convert.ToInt32(gvScore.DataKeys[e.RowIndex].Value);
            BasEmScoreInfo.DelAssistantScore(AsScoreId);
            gvDataBind();
        }
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            MessageInfo.Msgs1(recvid, at.AssistantScoreId, "~/Score/AsistantScoreApprove.aspx", em.EmployeeName + "绩效考核申请", em.EmployeeName, "daiban", em.EmployeeName + "绩效考核申请");
        ...
        {
            int AsScoreId = Convert.ToInt32(((Button)sender).CommandArgument.ToString());
            Response.Redirect("AsistantScoreEdit.aspx?AsScoreId=" + AsScoreId);
        }
        ...
        protected void btnJz_Click(object sender, EventArgs e)
        {
