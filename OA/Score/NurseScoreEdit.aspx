<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NurseScoreEdit.aspx.cs" MasterPageFile="~/Apply1.Master" Inherits="OA.Score.NurseScoreEdit" %>
                ...
                <td>
                    <table class="Tb_Common" style="width:100%;">
                       ...
                       <tr>
                        ...
                        <td><input type="text" name="Selfns1" class="Input1" value="<%=Selfns1 %>" /></td>
                        <td></td>
                        <td></td>
                        <td>5</td>
                       </tr>
                       <tr>
                        <td colspan="4">
                            <span >
                                工作不偷懒、不倦怠</span></td>
                        <td><input type="text" name="Selfns2" class="Input1" value="<%=Selfns2 %>" /></td>
                        <td></td>
                        <td></td>
                        <td>5</td>
                       </tr>
                       <tr>
                            <td colspan="4" style="height: 25px">
                                <span>
                                    做事敏捷、效率高</span></td>
                            <td style="height: 25px"><input type="text" name="Selfns3" class="Input1" value="<%=Selfns3 %>" /></td>
                       ...
                       <tr>
                         <td colspan="4">
                             <span>
                                 遵守上司的指示</span></td>
                            <td><input type="text" name="Selfns4" class="Input1" value="<%=Selfns4 %>" /></td>
                            <td></td>
                            <td></td>
                            <td>5</td>
                       </tr>
                        <tr>
                            ...
                            <td><input type="text" name="Selfns5" class="Input1" value="<%=Selfns5 %>"/></td>
                            <td></td>
                            <td></td>
                            <td>5</td>
                       </tr>
                       ...
                       <tr>
                        ...
                        <td><input type="text" name="Selfns6" class="Input1" value="<%=Selfns6 %>" /></td>
                        <td></td>
                        <td></td>
                        <td>5</td>
                       </tr>
                       <tr>
                        ...
                        <td><input type="text" name="Selfns7" class="Input1" value="<%=Selfns7 %>"/></td>
                        <td></td>
                        <td></td>
                        <td>3</td>
                       </tr>
                        ...
                        <td><input type="text" name="Selfns8" class="Input1" value="<%=Selfns8 %>"/></td>
                        <td></td>
                        <td></td>
                        <td>3</td>
                       </tr>
                       <tr>
                        ...
                        <td><input type="text" name="Selfns9" class="Input1" value="<%=Selfns9 %>"/></td>
                        <td></td>
                        <td></td>
                        <td>5</td>
                       </tr>
                       <tr>
                        ...
                        <td colspan="4">完成每天中午员工用餐，及计划每日菜单</td>
                         <td ><input type="text" name="Selfns10" class="Input1" value="<%=Selfns10 %>"/></td>
                        <td ></td>
                        <td ></td>
                        <td >8</td>
                       </tr>
                       <tr>
                        ...
                        <td><input type="text" name="Selfns11" class="Input1" value="<%=Selfns11 %>"/></td>
                        <td></td>
                        <td></td>
                        <td>8</td>
                       </tr>
                       <tr>
                        ...
                        <td><input type="text" name="Selfns12" class="Input1" value="<%=Selfns12 %>"/></td>
                        <td></td>
                        <td></td>
                        <td>5</td>
                       </tr>
                       <tr>
                        ...
                        <td><input type="text" name="Selfns13" class="Input1" value="<%=Selfns13 %>"/></td>
                        <td></td>
                        <td></td>
                        <td>5</td>
                       </tr>
                        ...
                        <td colspan="4">责任感强</td>
                         <td ><input type="text" name="Selfns14" class="Input1" value="<%=Selfns14 %>"/></td>
                        <td ></td>
                        <td ></td>
                        <td >3</td>
                       </tr>
                       <tr>
                        ...
                        <td><input type="text" name="Selfns15" class="Input1" value="<%=Selfns15 %>"/></td>
                        <td></td>
                        <td></td>
                        <td>3</td>
                       </tr>
                       <tr>
                        ...
                        <td><input type="text" name="Selfns16" class="Input1" value="<%=Selfns16 %>"/></td>
                        <td></td>
                        <td></td>
                        <td>3</td>
                       </tr>
                   ...
                   <tr>
                        ...
                        <td colspan="4">能与其他同事和睦相处</td>
                         <td ><input type="text" name="Selfns17" class="Input1" value="<%=Selfns17 %>"/></td>
                        <td ></td>
                        <td ></td>
                        <td >3</td>
                       </tr>
                       <tr>
                        ...
                        <td><input type="text" name="Selfns18" class="Input1" value="<%=Selfns18 %>"/></td>
                        <td></td>
                        <td></td>
                        <td>3</td>
                       </tr>
                       <tr>
                        ...
                        <td><input type="text" name="Selfns19" class="Input1" value="<%=Selfns19 %>"/></td>
                        <td></td>
                        <td></td>
                        <td>3</td>
                       </tr>
                       ...
                       <tr>
                        ...
                        <td colspan="4">
                         ...
                         <td ><input type="text" name="Selfns20" class="Input1" value="<%=Selfns20 %>"/></td>
                        <td ></td>
                        <td ></td>
                        <td >3</td>
                       </tr>
                       <tr>
                        ...
                        <td><input type="text" name="Selfns21" class="Input1" value="<%=Selfns21 %>"/></td>
                        <td></td>
                        <td></td>
                        <td>3</td>
                       </tr>
                       <tr>
                        ...
                        <td><input type="text" name="Selfns22" class="Input1" value="<%=Selfns22 %>"/></td>
                        <td></td>
                        <td></td>
                        <td>3</td>
                       </tr>
                        ...
                        <td><input type="text" name="Selfns23" class="Input1" value="<%=Selfns23 %>"/></td>
                        <td></td>
                        <td></td>
                        <td>3</td>
                       </tr>
