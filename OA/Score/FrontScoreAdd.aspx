<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrontScoreAdd.aspx.cs" MasterPageFile="~/Apply1.Master" Inherits="OA.Score.FrontScoreAdd" %>
                ...
                <td>
                    <table class="Tb_Common" style="width:100%;">
                       ...
                       <tr>
                        ...
                        <td><input type="text" name="Selffs1" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>5</td>
                       </tr>
                       <tr>
                        ...
                        <td><input type="text" name="Selffs2" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>
                            3</td>
                       ...
                       <tr>
                            ...
                            <td><input type="text" name="Selffs3" class="Input1" /></td>
                            <td></td>
                            <td></td>
                            <td>
                                5</td>
                       ...
                       <tr>
                         <td colspan="4">
                            ...
                            <td><input type="text" name="Selffs4" class="Input1" /></td>
                            <td></td>
                            <td></td>
                            <td>
                                8</td>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="Selffs5" class="Input1" /></td>
                            <td></td>
                            <td></td>
                            <td>5</td>
                       </tr>
                       ...
                       <tr>
                        ...
                        <td><input type="text" name="Selffs6" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>
                            3</td>
                       ...
                       <tr>
                        ...
                        <td><input type="text" name="Selffs7" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>
                            5</td>
                        ...
                        <td><input type="text" name="Selffs9" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>
                            5</td>
                        ...
                        <td><input type="text" name="Selffs10" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>
                            4</td>
                       ...
                       <tr>
                        ...
                        <td><input type="text" name="Selffs11" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>5</td>
                       </tr>
                       <tr>
                        <td colspan="4">公司重要文件资料的管理及合理的归档，在需要时能够迅速的找到。</td>
                         <td ><input type="text" name="Selffs12" class="Input1" /></td>
                        <td ></td>
                        <td ></td>
                        <td >
                            5</td>
                       ...
                       <tr>
                        ...
                        <td><input type="text" name="Selffs13" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>
                            5</td>
                       ...
                       <tr>
                        ...
                        <td><input type="text" name="Selffs14" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>5</td>
                       </tr>
                       <tr>
                        ...
                        <td><input type="text" name="Selffs15" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>5</td>
                       </tr>
                        ...
                        <td colspan="4">积极保守公司商业秘密，并能制定相应策略或制度监督其他部门员工执行。</td>
                         <td ><input type="text" name="Selffs16" class="Input1" /></td>
                        <td ></td>
                        <td ></td>
                        <td >
                            5</td>
                       ...
                       <tr>
                        ...
                        <td><input type="text" name="Selffs17" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>
                            5</td>
                       ...
                       <tr>
                        ...
                        <td><input type="text" name="Selffs18" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>
                            5</td>
                        ...
                        <td><input type="text" name="Selffs19" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>
                            5</td>
                   ...
                   <tr>
                        ...
                        <td colspan="4">对国家行政人事法律法规能够及时理解，并为公司提供良好的指导方向。</td>
                         <td ><input type="text" name="Selffs20" class="Input1" /></td>
                        <td ></td>
                        <td ></td>
                        <td >
                            7</td>
                       ...
                       <tr>
                        ...
                        <td><input type="text" name="Selffs21" class="Input1" /></td>
                        <td></td>
                        <td></td>
                        <td>
                            5</td>
