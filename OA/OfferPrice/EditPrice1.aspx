<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Apply.Master"  CodeBehind="EditPrice1.aspx.cs" Inherits="OA.OfferPrice.EditPrice1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content2" runat="server">
  <table class="Tb_Blank" style="width:100%;">
             <tr>
                 <td colspan="2" style="text-align:right;"><asp:Button ID="btnSign" runat="server" Text="签名" OnClick="btnSign_Click" /></td>
             </tr>
             <tr>
               <td>
