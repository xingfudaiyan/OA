<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Apply.Master" CodeBehind="Detail.aspx.cs" Inherits="OA.OfferPrice.Detail" %>
        ...
        <tr>
         ...
         <table class="Tb_Blank" style="width:100%;">
            <tr>
                ...
                <td style="width:35%;"><asp:Image ID="imgMarket" runat="server" Visible="false" ImageUrl="~/images/hechun.jpg" /></td>
...
<table class="Tb_Blank" style="width:100%;">
              <tr>
                <td colspan="4"><asp:Button ID="btnBack" runat="server" Text="返回" OnClick="btnBack_Click" /></td>
              </tr>
</table>
</asp:Content>
