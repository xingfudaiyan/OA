<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Manage.Master" CodeBehind="PrePriceApprove.aspx.cs" Inherits="OA.OfferPrice.PrePriceApprove" %>
                        ...
                        <td colspan="2">
                            <table class="Tb_Blank1">
                                <tr>
                                        ...
                                        <td  style="width:40%; text-align:right;"> <asp:Button ID="btnApply" runat="server" Text="申请" OnClick="btnApply_Click" /></td>
                                        <td style="width:6%;"></td>
                                </tr>
                            </table>
                        </td>
                                 ...
                                 <asp:GridView ID="gvPrice" runat="server" AllowSorting="true" CellPadding="1" Width="100%" AutoGenerateColumns="false" DataKeyNames="OfferPriceId" OnRowDataBound="gvPrice_RowDataBound" OnSorting="gvPrice_Sorting">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="申请人" SortExpression="PreEmployeeName">
                                            <ItemTemplate>
                                                <asp:Label ID="lblSendEmployee" runat="server" Text='<%#Eval("PreEmployeeName") %>'></asp:Label>
                                            </ItemTemplate>
                                             <ItemStyle Width="10%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="申请时间" SortExpression="PreApplyTime">
                                         ...
                                         <asp:TemplateField HeaderText="申批时间" SortExpression="ApproveTime">
                                            <ItemTemplate>
