<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Manage.Master" CodeBehind="PrePriceApply.aspx.cs" Inherits="OA.OfferPrice.PrePriceApply" %>
                                  ...
                                  <asp:GridView ID="gvPrice" runat="server" AllowSorting="true" CellPadding="1" Width="100%" AutoGenerateColumns="false" DataKeyNames="OfferPriceId" OnRowDataBound="gvPrice_RowDataBound" OnSorting="gvPrice_Sorting">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="项目名称" SortExpression="ProjectName"> 
                                             <ItemTemplate>
                                                <asp:Label ID="lblName" runat="server" Text='<%#Eval("ProjectName") %>'></asp:Label>
                                            </ItemTemplate>
                                             <ItemStyle Width="15%" />
                                        </asp:TemplateField>
