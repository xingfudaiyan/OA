<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PriceApprove1.aspx.cs" Inherits="OA.OfferPrice.PriceApprove1" %>
    ...
    <div>
      <table class="Tb_Blank">
        <tr>
            ...
            <td><asp:TextBox ID="txtSheetNum" runat="server" ></asp:TextBox></td>
            <td> <asp:Label ID="lblProjectName" runat="server" Text="项目名称"></asp:Label></td>
      ...
      <asp:GridView ID="gvPrice" runat="server" AllowSorting="true" CellPadding="1" Width="100%" AutoGenerateColumns="false" DataKeyNames="OfferPriceId" OnRowDataBound="gvPrice_RowDataBound" OnSorting="gvPrice_Sorting">
            <Columns>
                ...
                <asp:TemplateField HeaderText="审批状态">
                 ...
                 <asp:TemplateField HeaderText="申批时间" SortExpression="Apply1Time">
                    <ItemTemplate>
                ...
                <asp:TemplateField >
                    <ItemTemplate>
                         <tr>
                            <td colspan="100%">
                                 <div id="div<%# Eval("OfferPriceID") %>" style="display:none;position:relative;left:4.3%;OVERFLOW: auto;WIDTH:96%" >
