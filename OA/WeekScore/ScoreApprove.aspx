<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScoreApprove.aspx.cs" MasterPageFile="~/Manage.Master" Inherits="OA.WeekScore.ScoreApprove" %>
            ...
            <tr>
                <td>
                     <table style="width:100%; text-align:center; ">
                        <tr>
                            <td colspan="2"><h2><asp:Label ID="lblEm" runat="server"></asp:Label><asp:Label ID="lblNum" runat="server"></asp:Label>_周报评分</h2></td>
                        </tr>
                        <tr>
                            <td colspan="2" style="height:300px; vertical-align:top;">
                                   <asp:GridView ID="gvScore" runat="server" AutoGenerateColumns="False" DataKeyNames="DayScoreId" AllowSorting="True" CellPadding="1" Width="100%"  OnRowDataBound="gvScore_RowDataBound"  OnSorting="gvScore_Sorting"  >
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="日期" SortExpression="Today"> 
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="评分" SortExpression="Score"> 
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtScore" runat="server" Text='<%#Eval("Score") %>' SkinID="skinid3"></asp:TextBox>
                                                </ItemTemplate>
                                                <ItemStyle Width="5%" />
                                            </asp:TemplateField>
                                        </Columns>
                         ...
                         <tr>
                           <td colspan="2">
                            <table class="Tb_Blank1" style="width:50%; margin-left:25%;">
                                <tr>
                                        <td><asp:Button ID="btnSave" runat="server" Text="保存" OnClientClick="return confirm('保存后评分不能修改，确认要保存吗？');" OnClick="btnSave_Click" /></td>
