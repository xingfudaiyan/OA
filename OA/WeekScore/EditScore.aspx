<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditScore.aspx.cs" MasterPageFile="~/Manage.Master" Inherits="OA.WeekScore.EditScore" %>
            ...
            <tr>
                <td>
                     <table style="width:100%; text-align:center; ">
                        <tr>
                            <td colspan="2"><h2>编辑周报_<asp:Label ID="lblNum" runat="server"></asp:Label></h2></td>
                        </tr>
                         <tr>
                        <td colspan="2">
