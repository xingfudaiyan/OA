<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Apply1.Master" CodeBehind="Detail.aspx.cs" Inherits="OA.ProjectCreate.Detail" %>
            ...
            <tr>
                ...
                <td colspan="5">
                    <table class="Tb_Common" style="text-align:center;">
                        ...
                        <tr>
                           <td><asp:Label ID="lblMarketView" runat="server"></asp:Label></td>
                            <td><asp:Label ID="lblTechView" runat="server"></asp:Label></td>
