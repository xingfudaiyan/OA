...
{
    public partial class TechGv : System.Web.UI.Page
    {
        ...
        {
            DataTable dt = ProjectCreateInfo.getProjectApproveOfTech(Session["DepartName"].ToString());
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("TechApprove.aspx?ProjectCreateId=" + cid);
        }
