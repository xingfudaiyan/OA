<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Apply1.Master" CodeBehind="Detail.aspx.cs" Inherits="OA.Holiday.Detail" %>
            ...
            <td>
                <table class="Tb_Common">
                    ...
                    <tr>
                          <td>批示</td>
                          <td>直属主管</td>
                          <td><asp:TextBox ID="txtUperView" runat="server" TextMode="MultiLine" ReadOnly="true"></asp:TextBox></td>
                          <td>总经理</td>
                          <td><asp:TextBox ID="txtManagerView" runat="server" TextMode="MultiLine" ReadOnly="true"></asp:TextBox></td>
                          <td>综合部</td>
                          <td><asp:TextBox ID="txtHrView" runat="server"  TextMode="MultiLine" ReadOnly="true"></asp:TextBox></td>
                          <td>备注</td>
