<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Manage.Master" CodeBehind="ManagerGv.aspx.cs" Inherits="OA.Holiday.ManagerGv" %>
                                 ...
                                 <asp:GridView ID="gvHoliday" runat="server" AutoGenerateColumns="false" CellPadding="1" AllowSorting="true" Width="100%" DataKeyNames="HolidayApplyId" OnRowDataBound="gvHoliday_RowDataBound" OnSorting="gvHoliday_Sorting" >
                                        <Columns>
                                           ...
                                           <asp:TemplateField HeaderText="申请人" SortExpression="ApplyName">
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:Button ID="btnSubmit" Text="审批" runat="server" CommandArgument='<%#Eval("HolidayApplyId") %>' CausesValidation="false" OnClick="btnSubmit_Click" />
                                                </ItemTemplate>
                                                 <ItemStyle Width="10%" />
                                            </asp:TemplateField>
                                        </Columns>
