<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Apply1.Master" CodeBehind="AddHoliday.aspx.cs" Inherits="OA.Holiday.AddHoliday" %>
            ...
            <td>
                <table class="Tb_Common">
                    ...
                    <tr>
                        ...
                        <asp:TextBox ID="txtTimeSum" runat="server" ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="6" style="text-align:left;">
                            <asp:TextBox ID="txtEndTime" runat="server" SkinID="skinid3" onclick="WdatePicker()"></asp:TextBox>止
