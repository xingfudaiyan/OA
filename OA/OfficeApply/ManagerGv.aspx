<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Manage.Master" CodeBehind="ManagerGv.aspx.cs" Inherits="OA.OfficeApply.ManagerGv" %>
                            ...
                            <td colspan="2" style="height:300px; vertical-align:top;">
                                 <asp:GridView ID="gvOffice" runat="server" AutoGenerateColumns="false" CellPadding="1" AllowSorting="true" Width="100%" DataKeyNames="WorkToolSumId" OnRowDataBound="gvOffice_RowDataBound" OnSorting="gvOffice_Sorting"      >
                                        <Columns>
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:Button ID="btnSubmit" Text="审批" runat="server" CommandArgument='<%#Eval("WorkToolSumId") %>' CausesValidation="false" OnClick="btnSubmit_Click"   />
                                                </ItemTemplate>
                                                 <ItemStyle Width="10%" />
                                            </asp:TemplateField>
                                        </Columns>
