<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Apply1.Master"  CodeBehind="EditOffice.aspx.cs" Inherits="OA.OfficeApply.EditOffice" %>
                ...
                <td colspan="2">
                    <table class="Tb_Common">
                        <tr>
                         ...
                         <tr>
                             <td>借款用途及理由<span style="color:Red;">*</span></td>
                             <td colspan="3">
                         ...
                         <tr>
                             ...
                             <td colspan="3" style="text-align:left;">(大写)￥
                       ...
                       <tr>
                         <td colspan="3" style="text-align:left;">(小写)￥
