...
{
    public partial class TreatApprove2 : System.Web.UI.Page
    {
        ...
        protected void gvDataBind()
        {
            ...
            DataTable dt = BusinessExpInfo.getBusinessExpListOfApprove2(emid);
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("TApp2.aspx?BusinessExpId=" + wksumId);
        }
        ...
        protected void gvBusiness_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (!Convert.IsDBNull(gvBusiness.DataKeys[e.Row.RowIndex].Value))
                {
                    ...
                    DataTable dt=BusinessExpInfo.getBusinessExpListOfApproves2(emid, mainid);
