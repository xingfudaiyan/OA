<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Apply.Master" CodeBehind="Detail.aspx.cs" Inherits="OA.TreatApply.Detail" %>
...
<table class="Tb_Blank" style="width:100%;">
        ...
        <table class="Tb_Blank" style="width:100%;">
            <tr>
                ...
                <td style="width:35%;"><asp:Image ID="imgManager" runat="server" ImageUrl="~/images/qidawei.jpg" Visible="false" /></td>
            </tr>
        </table>
