<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Manage.Master" CodeBehind="OutApprove.aspx.cs" Inherits="OA.OutRegist.OutApprove" %>
                                  ...
                                  <asp:GridView ID="gvOutRegist" runat="server" AutoGenerateColumns="False" DataKeyNames="OutRegistId" AllowSorting="True" CellPadding="1" Width="100%" OnRowDataBound="gvOutRegist_RowDataBound" OnSorting="gvOutRegist_Sorting">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="状态" SortExpression="State">
                                             ...
                                             <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:Button ID="btnSubmit" Text="同意" runat="server" CommandArgument='<%#Eval("OutRegistId") %>' CausesValidation="false" OnClick="btnSubmit_Click"/>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                             <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:Button ID="btnNoSubmit" Text="不同意" runat="server" CommandArgument='<%#Eval("OutRegistId") %>' CausesValidation="false" OnClick="btnNoSubmit_Click"/>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
