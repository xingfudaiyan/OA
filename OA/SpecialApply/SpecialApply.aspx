<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Manage.Master" CodeBehind="SpecialApply.aspx.cs" Inherits="OA.SpecialApply.SpecialApply" %>
                        ...
                        <tr>
                            ...
                            <table class="Tb_Blank1">
                                <tr>
                                        ...
                                        <td  style="width:30%; text-align:right;"> <asp:Button ID="btnAddSheet" runat="server" Text="新增" OnClick="btnAddSale_Click"/></td>
                                        <td  style="width:10%;"><asp:Button ID="btnBack" runat="server" Text="返回" OnClick="btnBack_Click" /></td>
                                </tr>
                            </table>
                        </td>
                        </tr>
