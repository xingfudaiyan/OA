<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Apply.Master" CodeBehind="DepartApprove.aspx.cs" Inherits="OA.FileApply.DepartApprove" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Content1" runat="server">
 <table class="Tb_Blank" style="width:100%;">
        ...
        <tr>
            ...
            <tr>
                <td>申请人</td>
                <td><asp:Label ID="lblEm" runat="server"></asp:Label></td>
                <td>
                    申请时间</td>
