...
{
    public partial class Departgv : System.Web.UI.Page
    {
        ...
        {
            DataTable dt = FileApplyInfo.DepartGv(Session["DepartName"].ToString());
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("DepartApprove.aspx?FileApplyId=" + fid);
        }
        ...
        protected void lbtnDetail_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("FileDetail.aspx?FileApplyId=" + fid);
        }
    }
}
