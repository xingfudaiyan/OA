<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Manage.Master" CodeBehind="DepartApply.aspx.cs" Inherits="OA.FileApply.DepartApply" %>
                                 ...
                                 <asp:GridView ID="gvFileApply" runat="server" AutoGenerateColumns="false" CellPadding="1" AllowSorting="true" Width="100%" DataKeyNames="FileApplyId" OnRowDataBound="gvFileApply_RowDataBound" OnRowDeleting="gvFileApply_RowDeleting" OnSorting="gvFileApply_Sorting" >
                                        <Columns>
                                            <asp:TemplateField HeaderText="序号">
                                                 <ItemTemplate>
                                                    <asp:LinkButton ID="lbtnDetail" runat="server" style="text-decoration:none;" CommandArgument='<%#Eval("FileApplyId") %>' CausesValidation="false"   >  <%#Container.DataItemIndex+1 %></asp:LinkButton>
                                                </ItemTemplate>
                                                 <ItemStyle Width="5%" />
                                            </asp:TemplateField>
                                             ...
                                             <asp:TemplateField HeaderText="状态" SortExpression="IsApply">
                                                <ItemTemplate>
