...
namespace CanYou.OA.DAL{
    /// <summary>
    /// Strongly-typed collection for the Vw_RecvMaster class.
    /// </summary>
    [Serializable]
    public partial class Vw_RecvMasterCollection : ReadOnlyList<Vw_RecvMaster, Vw_RecvMasterCollection>
    {        
        public Vw_RecvMasterCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the vw_RecvMaster view.
    /// </summary>
    [Serializable]
    public partial class Vw_RecvMaster : ReadOnlyRecord<Vw_RecvMaster>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vw_RecvMaster", TableType.View, DataService.GetInstance("SubsonicProvider"));
                ...
                DataService.Providers["SubsonicProvider"].AddSchema("vw_RecvMaster",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public Vw_RecvMaster()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public Vw_RecvMaster(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public Vw_RecvMaster(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public Vw_RecvMaster(string columnName, object columnValue)
        {
            SetSQLProps();
