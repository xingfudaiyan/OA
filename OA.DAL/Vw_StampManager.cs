...
namespace CanYou.OA.DAL{
    /// <summary>
    /// Strongly-typed collection for the Vw_StampManager class.
    /// </summary>
    [Serializable]
    public partial class Vw_StampManagerCollection : ReadOnlyList<Vw_StampManager, Vw_StampManagerCollection>
    {        
        public Vw_StampManagerCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the vw_StampManager view.
    /// </summary>
    [Serializable]
    public partial class Vw_StampManager : ReadOnlyRecord<Vw_StampManager>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vw_StampManager", TableType.View, DataService.GetInstance("SubsonicProvider"));
                ...
                DataService.Providers["SubsonicProvider"].AddSchema("vw_StampManager",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public Vw_StampManager()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public Vw_StampManager(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public Vw_StampManager(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public Vw_StampManager(string columnName, object columnValue)
        {
            SetSQLProps();
