...
namespace CanYou.OA.DAL{
    /// <summary>
    /// Strongly-typed collection for the Vw_FrontM class.
    /// </summary>
    [Serializable]
    public partial class Vw_FrontMCollection : ReadOnlyList<Vw_FrontM, Vw_FrontMCollection>
    {        
        public Vw_FrontMCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the vw_FrontM view.
    /// </summary>
    [Serializable]
    public partial class Vw_FrontM : ReadOnlyRecord<Vw_FrontM>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vw_FrontM", TableType.View, DataService.GetInstance("SubsonicProvider"));
                ...
                colvarFrontScoreId.AutoIncrement = false;
                colvarFrontScoreId.IsNullable = false;
                colvarFrontScoreId.IsPrimaryKey = false;
                ...
                DataService.Providers["SubsonicProvider"].AddSchema("vw_FrontM",schema);
            }
        }
        #endregion
        ...
        public Vw_FrontM(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public Vw_FrontM(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public Vw_FrontM(string columnName, object columnValue)
        {
            SetSQLProps();
        ...
        public int FrontScoreId 
	    {
		    get
		    {
			    return GetColumnValue<int>("FrontScoreId");
		    }
            set 
		    {
			    SetColumnValue("FrontScoreId", value);
            }
        }
