...
namespace CanYou.OA.DAL{
    /// <summary>
    /// Strongly-typed collection for the Vw_HolidayList class.
    /// </summary>
    [Serializable]
    public partial class Vw_HolidayListCollection : ReadOnlyList<Vw_HolidayList, Vw_HolidayListCollection>
    {        
        public Vw_HolidayListCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the vw_HolidayList view.
    /// </summary>
    [Serializable]
    public partial class Vw_HolidayList : ReadOnlyRecord<Vw_HolidayList>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vw_HolidayList", TableType.View, DataService.GetInstance("SubsonicProvider"));
                ...
                DataService.Providers["SubsonicProvider"].AddSchema("vw_HolidayList",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public Vw_HolidayList()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public Vw_HolidayList(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public Vw_HolidayList(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public Vw_HolidayList(string columnName, object columnValue)
        {
            SetSQLProps();
