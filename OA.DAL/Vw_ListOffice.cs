...
namespace CanYou.OA.DAL{
    /// <summary>
    /// Strongly-typed collection for the Vw_ListOffice class.
    /// </summary>
    [Serializable]
    public partial class Vw_ListOfficeCollection : ReadOnlyList<Vw_ListOffice, Vw_ListOfficeCollection>
    {        
        public Vw_ListOfficeCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the vw_ListOffice view.
    /// </summary>
    [Serializable]
    public partial class Vw_ListOffice : ReadOnlyRecord<Vw_ListOffice>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vw_ListOffice", TableType.View, DataService.GetInstance("SubsonicProvider"));
                ...
                DataService.Providers["SubsonicProvider"].AddSchema("vw_ListOffice",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public Vw_ListOffice()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public Vw_ListOffice(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public Vw_ListOffice(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public Vw_ListOffice(string columnName, object columnValue)
        {
            SetSQLProps();
