...
namespace CanYou.OA.DAL{
    /// <summary>
    /// Strongly-typed collection for the Vw_ListTool class.
    /// </summary>
    [Serializable]
    public partial class Vw_ListToolCollection : ReadOnlyList<Vw_ListTool, Vw_ListToolCollection>
    {        
        public Vw_ListToolCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the vw_ListTool view.
    /// </summary>
    [Serializable]
    public partial class Vw_ListTool : ReadOnlyRecord<Vw_ListTool>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vw_ListTool", TableType.View, DataService.GetInstance("SubsonicProvider"));
                ...
                DataService.Providers["SubsonicProvider"].AddSchema("vw_ListTool",schema);
            }
        }
        #endregion
        ...
        public Vw_ListTool(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public Vw_ListTool(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public Vw_ListTool(string columnName, object columnValue)
        {
            SetSQLProps();
