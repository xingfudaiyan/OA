...
namespace CanYou.OA.BLL
{
	...
	/// </summary>
	[Serializable]
	public partial class NoticeInfo:CanYou.EntityObject
	{
		#region 属性
		///<summary>
		///
		...
		///
		///</summary>
		private string noticeContent = String.Empty;
		///<summary>
		///
		///</summary>
		...
		///
		///</summary>
		private string noticeTime = String.Empty;
		///<summary>
		///
		///</summary>
		...
		///
		///</summary>
		public NoticeInfo(int pNoticeId,string pNoticeContent,string pSignName,string pNoticeTime,string pNoticeTitle,string pEmployeeName)
		{
			noticeId      = pNoticeId;
			noticeContent = pNoticeContent;
			signName      = pSignName;
			noticeTime    = pNoticeTime;
        ...
        /// <param name="Id"></param>
        /// <returns></returns>
        public static  NoticeInfo Find(List< NoticeInfo> list,  int noticeId)
        {
             return list.Find(delegate( NoticeInfo item) { return item. noticeId==noticeId; });
        }
        ...
        {
            return string.Format(CachedEntityCommander.CacheKey, typeof( NoticeInfo).ToString());
        }
