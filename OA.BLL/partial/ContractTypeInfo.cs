...
{
	/// <summary>
	///ContractTypeInfo  Data
	/// </summary>
	[Serializable]
	public partial class ContractTypeInfo:CanYou.EntityObject
	{
		#region 属性
		///<summary>
		///
		...
		///
		///</summary>
		public ContractTypeInfo(int pContractTypeId,string pContractTypeName)
		{
		...
		///
		///</summary>
		public ContractTypeInfo(int contractTypeId)
		{
			 LoadFromId(contractTypeId);
		}
        ...
        /// <param name="Id"></param>
        /// <returns></returns>
        public static  ContractTypeInfo Find(List< ContractTypeInfo> list,  int contractTypeId)
        {
             return list.Find(delegate( ContractTypeInfo item) { return item. contractTypeId==contractTypeId; });
        }
        ...
        {
            return string.Format(CachedEntityCommander.CacheKey, typeof( ContractTypeInfo).ToString());
        }
		...
		public  override void Delete()
		{
			if(!m_Loaded)
				throw new AppException("尚未初始化");
			bool result=  (ContractType.Delete(ContractTypeId) == 1);
			//更新缓存
			if (result&&CachedEntityCommander.IsTypeRegistered(typeof(ContractTypeInfo))) 
            {
                ResetCache();
            }
            if(!result)
		...
		public override void Save()
		{
			if(!m_Loaded)//新增
			{
				...
				SaveToDb(this, contractType,true);
			}
			else//修改
			{
				ContractType contractType=new ContractType(contractTypeId);	
				...
				SaveToDb(this, contractType,false);
			}
